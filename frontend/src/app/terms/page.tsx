  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentBody}>
        <div>
          <p>
            Welcome to the Gamebite website (the &quot;Website&quot;). These Terms of Service (These &quot;Terms&quot;) are concluded between Maxflow BV, a company incorporated under Belgian law, having its registered office at Philipssite 5 bus 001, 3001 Leuven, Belgium, registered under company registration number 0804.839.227 under trade name &quot;Gamebite&quot; (&quot;Gamebite&quot;, &quot;we&quot;, &quot;us&quot;) and the User (&quot;User&quot;, &quot;you&quot; or &quot;your&quot;) (together, the &quot;Parties&quot;). Gamebite provides you access to the Website. A User is a person who visits the Website and/or the Platform, plays web games, registers via any form available on the Website, or otherwise subscribes or enters into a contract with Gamebite.
          </p>
        </div>
        ...
        <div>
          <p>
            The Platform is intended for visitors and users who are thirteen (13) years of age (or the applicable minimum age in your country) or older. If you are under thirteen (13) years of age (or the applicable minimum age in your country) through our Platform. However, we may offer specific games suitable for younger children below the applicable minimum age, https://kids.Gamebite.com/ (&quot;Kids Site&quot;) and have a separate privacy policy applicable to the Kids Site at kids.Gamebite.com/privacy-policy. Gamebite does not allow personalised advertising on its Kids Site.
          </p>
        </div>
        ...
        <div className={styles.sectionBlock}>
          ...
          <p>
            You agree to use Gamebite strictly for personal, non-commercial entertainment purposes. Reverse engineering, scraping, or launching automated attacks on our servers is strictly prohibited.
          </p>
        </div>
        ...
        <div className={styles.sectionBlock}>
          ...
          <p>
            All game titles, trademarks, brand logos, graphics, and code packages on Gamebite are owned by Gamebite or licensed from respective H5 game developers.
          </p>
        </div>
        ...
        <div className={styles.sectionBlock}>
          ...
          <p>
            You are responsible for maintaining the confidentiality of your login credentials. Gamebite reserves the right to terminate accounts that violate platform policies.
          </p>
        </div>
      </div>
    </div>
